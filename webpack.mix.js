...
mix.js('resources/js/app.js', 'public/js')
    ...
    .sass('resources/sass/pro.scss', 'public/css')
    .sass('resources/sass/talentsearch.scss', 'public/css')
    .sass('resources/sass/style.scss', 'public/css')
    .sass('resources/sass/navbar.scss', 'public/css')
    .sass('resources/sass/candidate.scss', 'public/css')
    .sass('resources/sass/jobvacancy.scss', 'public/css')
    .sass('resources/sass/login_employer.scss', 'public/css')
    .sass('resources/sass/onlineinterview.scss', 'public/css')
    .sass('resources/sass/onlineinterviewvideo.scss', 'public/css')
    .sass('resources/sass/onlinetesting.scss', 'public/css')
    .sass('resources/sass/onlinetestingresult.scss', 'public/css')
    .sass('resources/sass/register_employer.scss', 'public/css')
