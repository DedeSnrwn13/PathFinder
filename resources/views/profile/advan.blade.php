...
@section('title', 'Job Seeker | Advan Assessment')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="kategori">
                ...
                <a href="/jobseeker/profile/advancedassessment"><button class="advanced text-center aktif2">Advanced Assessment</button></a>
            </div>
        </div>
        <div class="col-md-9">
            <div class="adv">
