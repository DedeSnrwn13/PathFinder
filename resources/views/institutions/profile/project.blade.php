...
@section('title', 'My Student Profile | Profile Project')
    ...
    <div class="row mb-5">
        <div class="col-md-3">
            <div class="kategori">
                ...
                <a href="/institutions/mystudent/{{ $pelamar->id }}/profile/project"><button class="projects text-center aktif">Projects</button></a>
