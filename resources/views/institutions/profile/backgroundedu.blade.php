...
@section('title', 'My Student Profile | Background Education')
    ...
    <div class="row mb-5">
        <div class="col-md-3">
            <div class="kategori">
                ...
                <a href="/institutions/mystudent/{{ $pelamar->id }}/profile/backgroundeducation"><button class="backed text-center aktif">Background Education</button></a>
